...
<body class="bg-slate-900 text-white min-h-screen pb-20">
  ...
  <main class="max-w-lg mx-auto px-4 py-6 space-y-6">
    ...
    <div class="bg-slate-800 rounded-2xl p-5">
      <div class="flex items-center justify-between mb-4">
        ...
        <a href="/web/public/app/markets.php" class="text-emerald-400 text-xs hover:text-emerald-300 transition">See all →</a>
      </div>
      <div class="space-y-3">
    ...
    <div class="bg-slate-800 rounded-2xl p-5">
      <div class="flex items-center justify-between mb-4">
        ...
        <a href="/web/public/app/trading.php" class="text-emerald-400 text-xs hover:text-emerald-300 transition">Trade →</a>
      </div>
      <div class="space-y-3">
  ...
  <nav class="fixed bottom-0 left-0 right-0 bg-slate-900 border-t border-slate-700 flex justify-around py-2 z-50">
    <a href="/web/public/app/index.php" class="flex flex-col items-center text-xs text-emerald-400 gap-1">
